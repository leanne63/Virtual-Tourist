...
struct CoreDataStack {
	...
	static var applicationDocumentsDirectory: NSURL = {
		// The directory the application uses to store the Core Data store file. This code uses a directory named "com.leanne63.Virtual_Tourist" in the application's documents Application Support directory.
	...
	static var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
		...
		let url = CoreDataStack.applicationDocumentsDirectory.URLByAppendingPathComponent("SingleViewCoreData.sqlite")
